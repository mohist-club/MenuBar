cask "menubartranslator" do
  ...
  # `homebrew-<名字>` 这种格式,而这个仓库叫 MenuBar,不符合命名规则。
  ...
  #   brew install --cask ./Casks/menubartranslator.rb
  #
  # TODO: 每次发新版本后更新这三行:
  #   1. version 改成新版本号
  ...
  url "https://github.com/mohist-club/MenuBar/releases/download/v#{version}/MenuBarTranslator.zip"
  name "MenuBarTranslator"
  desc "划词翻译 + 全局快捷键启动应用的菜单栏工具"
  homepage "https://github.com/mohist-club/MenuBar"
